...
class M_pagination extends CI_Model{
  ...
  function set_config(
    ...
    $this->cur_tag_open = !empty($cur_tag_open) ?  $cur_tag_open : '&nbsp;<span>';
    $this->cur_tag_close = !empty($cur_tag_close) ? $cur_tag_close : '</span>' ;
    $this->next_link = !empty($next_link) ? $next_link : 'Next' ;
    $this->prev_link = !empty($prev_link) ? $prev_link : 'Previous' ;
