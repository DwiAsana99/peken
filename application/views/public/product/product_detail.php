  ...
  <div id="detail">
    <div class="contain_obj">
      <div class="mag">
        ...
        if ($i == 1 ) { ?>
        <img data-toggle="magnify" src="<?php echo base_url('assets/supplier_upload/').$p->FileName;?>" id="image<?php echo $i ?>" class="image-toggle">
        <?php } elseif($i > 1 AND $i < 6) {?>
        <img data-toggle="magnify" src="<?php echo base_url('assets/supplier_upload/').$p->FileName;?>" title="image 2" alt="image 2" id="image<?php echo $i ?>"
          class="image-toggle" style="display:none;">
        <?php }
        $i++;
        }
      ?>
    ...
    <div class="tab-content clearfix">
      ...
      <div class="tab-pane seller_detail" id="2a">
        ...
        <a href="<?php echo site_url('supplier/public_supplier_detail_view?')." id_supplier=".$p->IdSupplier ?>">
          <p>
            <img class=" img-responsive seller_img" src="<?php echo base_url('assets/supplier_upload/').$p->ProfilImage;  ?>"
