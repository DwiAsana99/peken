        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown messages-menu" id="supplier_unread_quotation_notification_bell">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="label label-warning">
                  <?php //echo $unread_quotation_num_rows; ?>
                </span>
              </a>
              <ul class="dropdown-menu">
                <li class="header">You have
                  <?php //echo $unread_quotation_num_rows; ?> unread quotation</li>
                <li>
                    ...
                    <?php// foreach($unread_quotation as $uq){ ?>
                      <li>
                        ...
                        <a href="<?php //echo base_url().'index.php/Quotation/supplier_quotation_detail?id_quotation='.$uq->IdQuotation; ?>">
                          ...
                          <h4>
                            <?php //echo $uq->CompanyName; ?>
                            <br>
                            <small>
                              <i class="fa fa-clock-o"></i>
                              <?php //echo $uq->DateSend; ?>
                            </small>
                          </h4>
            ...
            <script type="text/javascript">
              function reload_unread_quotation_notification_bell() {
                ...
                $.ajax({
                    type        : 'POST',
                    dataType:'html',
                    url         : "<?php echo base_url().'Quotation/get_unread_quotation_notification_bell'; ?>",
                    cache: false,
                    data        :  data,
            ...
            <li class="dropdown messages-menu" id="supplier_unread_chat_notification_bell">
              ...
              <ul class="dropdown-menu">
                <li class="header">You have unread comment in
                  <?php //echo $unread_quotation_detail_num_rows; ?> quotation</li>
                <li>
                  <!-- inner menu: contains the actual data -->
                  <ul class="menu">
